...
\begin{table}[h!]
    \centering
    \small
    \caption{Время выполнения алгоритмов подсчёта треугольников, в секундах, CI = 0.95.}
    ...
    \begin{tabular}{llcc}
        ...
        \multirow{4}{*}{web-Stanford}
            & burkhard-py   & $1.18 \pm 0.01$ & 0.52 \\
            & sandia-py     & $0.26 \pm 0.01$ & 0.51 \\
            & burkhard-lagr & $1.18 \pm 0.01$ & 0.87 \\
            & sandia-lagr   & $0.26 \pm 0.01$ & 1.00 \\
        \midrule
        ...
        \multirow{4}{*}{cit-Patents}
            & burkhard-py   & $4.32 \pm 0.01$  & 0.95 \\
            & sandia-py     & $0.68 \pm 0.01$  & 0.30 \\
            & burkhard-lagr & $4.31 \pm 0.01$  & 0.29 \\
            & sandia-lagr   & $0.70 \pm 0.01$  & 0.42 \\
        \midrule
        \multirow{4}{*}{amazon-2008}
            & burkhard-py   & $0.29 \pm 0.01$ & 0.44 \\
            & sandia-py     & $0.10 \pm 0.01$ & 0.29 \\
            & burkhard-lagr & $0.30 \pm 0.01$ & 0.29 \\
            & sandia-lagr   & $0.11 \pm 0.01$ & 0.86 \\
        \midrule
